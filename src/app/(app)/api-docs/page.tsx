    ...
    routes: [
      {
        method: "GET",
        path: "/api/accounts",
        description: "List all accounts with type, group, currency, and notes",
        example: `[{ "id": 1, "type": "A", "group": "Banks", "name": "Chequing", "currency": "CAD" }]`,
      },
      {
        method: "POST",
        path: "/api/accounts",
        ...
        example: `{ "id": 5, "type": "A", "group": "Banks", "name": "New Savings", "currency": "CAD" }`,
      },
    ],
  },
  {
...
const MCP_TOOLS = [
  ...
  { name: "get_transactions", type: "read", description: "Query transactions with filters" },
  ...
  { name: "get_portfolio_summary", type: "read", description: "Investment holdings grouped by account" },
  { name: "get_net_worth", type: "read", description: "Total net worth by currency" },
  ...
  { name: "get_net_worth_trend", type: "read", description: "Net worth over last N months" },
  { name: "get_portfolio_analysis", type: "read", description: "Portfolio analysis with allocation, concentration, returns" },
  { name: "get_portfolio_performance", type: "read", description: "TWR, XIRR, benchmark comparison" },
  { name: "analyze_holding", type: "read", description: "Single holding metrics: cost basis, P&L, dividends" },
  { name: "get_holding_metrics", type: "read", description: "Aggregated per-holding metrics for the portfolio" },
  { name: "get_rebalancing_suggestions", type: "read", description: "Target vs current allocation with suggested trades" },
  { name: "get_investment_insights", type: "read", description: "Concentration, diversification, sector overweights" },
  { name: "compare_to_benchmark", type: "read", description: "Compare portfolio return to market indices" },
  ...
  { name: "add_transaction", type: "write", description: "Add a new transaction" },
  { name: "record_transaction", type: "write", description: "Record a transaction (MCP v3 shape)" },
  { name: "update_transaction", type: "write", description: "Update a transaction by ID" },
  ...
  { name: "categorize_transaction", type: "write", description: "Update transaction category by ID" },
  { name: "add_account", type: "write", description: "Create a new account" },
  { name: "update_account", type: "write", description: "Update an account" },
  ...
  { name: "update_subscription", type: "write", description: "Update a subscription" },
  { name: "pause_subscription", type: "write", description: "Pause a subscription with optional resume date" },
  { name: "resume_subscription", type: "write", description: "Resume a paused subscription" },
  { name: "cancel_subscription", type: "write", description: "Cancel a subscription" },
