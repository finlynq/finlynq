...
export function McpGuide({ embedded = false }: { embedded?: boolean }) {
  const [activeTab, setActiveTab] = useState<ClientTab>("claude-web");
  ...
  return (
    <div className={embedded ? "" : "min-h-screen bg-background"}>
      {!embedded && <AnalyticsConsent />}
      <div className={embedded ? "mx-auto max-w-4xl" : "mx-auto max-w-4xl px-6 py-10"}>
        {/* Header */}
        <div className="mb-8">
                ...
                <li className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">
                      Replace <code className="bg-muted px-1 rounded">YOUR_API_KEY</code> with a key
                      generated from{" "}
